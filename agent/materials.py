...
MATERIALS: dict[str, dict] = {
    ...
    "ghibli": {
        ...
        "name": "Studio Ghibli",
        "style_instruction": (
            "Studio Ghibli inspired animation style by Hayao Miyazaki, hand-drawn 2D anime with "
            "lush painterly watercolor backgrounds, warm earthy and pastel color palette "
            "(soft greens, sky blues, golden yellows, warm umbers). Characters designed with "
            "simple expressive faces, large bright eyes, round gentle features, detailed flowing "
            "hair and fabric movement. Environments feature rolling countryside, ancient forests, "
            "rustic villages, dramatic cloudscapes, and cozy interiors with rich natural textures. "
            "Lighting is soft and diffused – golden-hour warmth, dappled sunlight through leaves, "
            "glowing lanterns at dusk. Atmosphere is nostalgic, peaceful, heartwarming, and "
            "slightly magical. Subtle ambient animation: swaying grass, drifting clouds, "
            "flickering fire, gentle water ripples. Frame-by-frame hand-drawn motion with "
            "gentle easing. Style reference: My Neighbor Totoro, Spirited Away, "
            "Howls Moving Castle, Princess Mononoke."
        ),
        "negative_prompt": (
            "NOT 3D, NOT CGI, NOT photorealistic, NOT live-action, borders, "
            "black bars, text, watermark."
        ),
        "scene_prefix": (
            "Studio Ghibli inspired animation style, hand-drawn 2D anime, lush painterly "
            "watercolor backgrounds, soft pastel colors, Hayao Miyazaki aesthetic."
        ),
